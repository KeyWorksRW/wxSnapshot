...
static int LUACALL wxLua_wxArtProvider_GetSizeHint(lua_State *L)
{
    ...
    // REVIEW: [Randalphwa - 10-16-2022] Starting with 3.1.6, second parameter is no longer a bool, but a wxWindow
    wxSize* returns = new wxSize(wxArtProvider::GetSizeHint(client));
    // add the new object to the tracked memory list
    wxluaO_addgcobject(L, returns, wxluatype_wxSize);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxSize);
...
static int LUACALL wxLua_wxArtProvider_RescaleBitmap(lua_State *L)
{
    ...
    // call RescaleBitmap
    // REVIEW: [Randalphwa - 10-16-2022] Deprecated, should call wxBitmap::Rescale() instead
